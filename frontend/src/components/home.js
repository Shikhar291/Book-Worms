            ...
            <div className="row pt-5 mt-3">
              <div className="col-md-12 wow fadeIn mb-3">
                <div className="text-center">
                  <h1 className="display-4 font-weight-bold mb-5 wow fadeInUp">Our New Novels are Ready</h1>
                  <h5 className="mb-5 wow fadeInUp" data-wow-delay="0.2s">It comes with a lot of new features, easy to buy
                    rent and affordable cost. Check it out now!</h5>
                  <div className="wow fadeInUp" data-wow-delay="0.4s">
                    <a className="btn btn-purple btn-rounded"><i className="fas fa-user left"></i> Sign up!</a>
                    <a className="btn btn-outline-purple btn-rounded"><i className="fas fa-book left"></i> Learn more</a>
                  </div>
                </div>
              </div>
            </div>
...
<div className="container">
  ...
  <section className="section wow fadeIn" data-wow-delay="0.3s">
    ...
    <h1 className="font-weight-bold text-center h1 my-5">Why is it so great?</h1>
   
    <p className="text-center grey-text mb-5 mx-auto w-responsive lead">Lorem ipsum dolor sit amet, consectetur
...
<footer className="page-footer pt-4 mt-4   text-center text-md-left mt-5">
    <div className="footer-copyright py-3 text-center">
      <div className="container-fluid">
        © 2019 Copyright: <a href="https://mdbootstrap.com/docs/jquery/"> Book Worms </a>
